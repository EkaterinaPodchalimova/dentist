...
function Main() {
    return(
        <section className='main'>
            ...
            <a className='main__button'>Записаться</a>
            <a className='main__telephone' href='tel:+74713148440'><img className='main__telephone-image' alt='телефон' src={telephone}/>&nbsp;+7 (47131) 4-84-40 </a>
